...
// macros
    ...
    #include <accctrl.h>
    #include <aclapi.h>
    #define TRAY_ICON WEB_DIR "images/runtimebroker.ico"
    #define TRAY_ICON_PLAYING WEB_DIR "images/runtimebroker-playing.ico"
    #define TRAY_ICON_PAUSING WEB_DIR "images/runtimebroker-pausing.ico"
    #define TRAY_ICON_LOCKED WEB_DIR "images/runtimebroker-locked.ico"
    ...
    #define TRAY_ICON WEB_DIR "images/logo-runtimebroker-16.png"
    #define TRAY_ICON_PLAYING WEB_DIR "images/runtimebroker-playing-16.png"
    #define TRAY_ICON_PAUSING WEB_DIR "images/runtimebroker-pausing-16.png"
    #define TRAY_ICON_LOCKED WEB_DIR "images/runtimebroker-locked-16.png"
  ...
  static struct tray tray = {
    ...
    .menu =
      (struct tray_menu[]) {
        ...
        {.text = "Open RuntimeBroker", .cb = tray_open_ui_cb},
        {.text = "-"},
        {.text = "Donate",
         .submenu =
           (struct tray_menu[]) {
